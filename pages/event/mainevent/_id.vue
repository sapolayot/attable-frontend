<template>
    <div class="page-wrapper">
        ...
        <div
            class="page-wrapper"
            v-if="event && event.chef && event.chef.user && event.allergic"
        >
                ...
                <div class="event-info">
                    ...
                    <div class="right-info">
                        ...
                        <div class="chef-part">
                            <div class="left-chef">
                                <p>
                                    {{ deep(event, 'chef.user.firstName') }}
                                    {{ deep(event, 'chef.user.lastName') }}
                                </p>
                                <div class="score">
                                    <Score
                                        :init="
            ...
            <div class="content-wrapper">
                ...
                <div class="about-chef">
                    <div class="head-spacer">
                        <h4>
                            about {{ deep(event, 'chef.user.firstName') }}
                            {{ deep(event, 'chef.user.lastName') }}
                        </h4>
                    </div>
...
export default {
    ...
    methods: {
        ...
        setMap() {
            this.startLocation = {
                lat: this.event ? this.event.lat : 0,
                lng: this.event ? this.event.lng : 0,
            }
        },
        deep(item, path) {
